  ...
  return (
    <div className="flex-grow overflow-y-auto p-6 fantasy-scrollbar">
                ...
                <div key={index} className="mb-6">
                  <div className="flex items-center mb-2">
                    ...
                    <div className="flex items-center">
                      ...
                      <button
                        onClick={() => { trackButtonClick("page", "跳转到此消息"); onTruncate(message.id); }}
                  ...
                  <ChatHtmlBubble html={message.content} isLoading={message.content.trim() === "" && index === messages.length - 1 && isSending} serifFontClass={serifFontClass} />
                </div>
              );
            })}
      ...
      <div className="bg-[#1a1816] border-t border-[#534741] p-4">
        ...
        <form onSubmit={(event) => {trackFormSubmit("page", "提交表单"); onSubmit(event);}} className="max-w-4xl mx-auto">
