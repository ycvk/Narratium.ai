...
4. <thought>：用于角色内心的独白或心理转折，如：
   <thought>她突然意识到，也许他早就察觉了她的退缩。</thought>

5. <memory>：插入梦境、时间跳跃或回忆内容，如：
   <memory>那是她第一次在雪地中看见他，身后是一大片未踏足的白。</memory>

6. <desire>：用于表达被压抑的渴望、欲望或情绪引力，如：
   <desire>他想靠近，却又害怕打破这层模糊的边界。</desire>
